<?php
        ...
        echo "<table id=\"data-table-lista-enti-perspesa-basic\" class=\"table table-striped\">";
        echo "<thead>";
        echo "<tr>";
        ...
        echo "<th data-column-id=\"codiceEnte\" data-type=\"string\" data-visible=\"false\">Codice</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
...
//        }
        foreach($tableElements as $tableElement)
        {
            ...
            echo "<td>" . $tableElement->cod_ente . "</td>";
            echo "</tr>";
        }
