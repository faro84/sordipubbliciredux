<?php
        ...
        echo "<table id=\"data-table-lista-regioni-perspesa-basic\" class=\"table table-striped\">";
        echo "<thead>";
        echo "<tr>";
        ...
        echo "<th data-column-id=\"codiceRegione\" data-type=\"string\" data-visible=\"false\">Codice</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
...
//                . " LIMIT 200;";
        ...
        $sql = "SELECT enti_spesatotale.cod_ente,enti_spesatotale.cod_comune, tipologia_ente,enti_spesatotale.cod_regione,"
        ...
        if ($result->num_rows > 0)
        {
            while($row = $result->fetch_assoc())
            {
                    ...
                    $tableelement->cod_regione = $row["cod_regione"];
...
//        }
        foreach($tableElements as $tableElement)
        {
            ...
            echo "<td>" . $tableElement->cod_regione . "</td>";
            echo "</tr>";
        }
