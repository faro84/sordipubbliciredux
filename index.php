    ...
    <body>
            ...
            <aside id="sidebar">
                <div class="sidebar-inner c-overflow">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="sub-menu">
                            <a href=""><i class="md md-now-widgets"></i> Overview</a>

                            <ul>
                                <li><a href="index.php?content=widget-template">Overview regioni</a></li>
                                <li><a href="widgets.html">Overview provincie</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                <?php include("php/definition/table_definition.php"); ?>
            });
